...
@section('breadcrumb')
	...
	<li class="active">@lang('equicare.create_accessorie')</li>
@endsection
@section('styles')
	<style type="text/css">
		.mt-2{
		...
		<div class="col-md-12">
			<div class="box box-primary">
					<div class="box-header with-border">
						<h4 class="box-title">
							@lang('equicare.create_accessorie')
						</h4>
					</div>
					<div class="box-body">
					@include ('errors.list')
						{!! Form::open(['url'=>'admin/accessories','method'=>'POST']) !!}
						<div class="row">
							...
							<div class="form-group col-md-6">
								{!! Form::label('code_ac',__('equicare.code_ac')) !!}
								{!! Form::text('code_ac',null,['class' => 'form-control']) !!}
							</div>
							<div class="form-group col-md-6">
								{!! Form::label('quantity_ac',__('equicare.quantity_ac')) !!}
