...
class BreakdownController extends Controller {
	...
	public function store(BreakdownCreateRequest $request) {
		...
		$breakdown->code_error = $request->code_error;
	...
	public function attend_call(Request $request) {
		...
		$validator = Validator::make($request->all(), [
			...
			'Steps_to_solve_the_problem'=> 'required',
			// 'Work_done'=> 'required',
		...
		$breakdown->working_status = $request->working_status;
		$breakdown->Steps_to_solve_the_problem = $request->Steps_to_solve_the_problem;
		// $breakdown->Work_done= $request->Work_done;
		$breakdown->save();
