					...
					<table id="data_table" class="table table-hover table-bordered table-striped">
						<thead>
							<tr>
								...
								<th> @lang('equicare.code_error') </th>
								<th> @lang('equicare.Steps_to_solve_the_problem') </th>
						...
						<tbody>
							...
							<tr>
								...
								<td> {{ $breakdown->code_error?ucfirst($breakdown->code_error): '-' }} </td>
								<td> {{ $breakdown->Steps_to_solve_the_problem?ucfirst($breakdown->Steps_to_solve_the_problem): '-' }} </td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						{!! Form::label('remarks',__('equicare.Work_done')) !!}
						{!! Form::textarea('remarks', null, ['class'=>'form-control remarks','rows'=>2]) !!}
					</div>
					<div class="form-group col-md-6">
						{!! Form::label('Steps_to_solve_the_problem',__('equicare.Steps_to_solve_the_problem')) !!}
						{!! Form::textarea('Steps_to_solve_the_problem', null, ['rows' => 4,'class'=>'form-control Steps_to_solve_the_problem']) !!}
					</div>
					{{-- <div class="form-group col-md-6">
						{!! Form::label('Work_done',__('equicare.Work_done')) !!}
						{!! Form::textarea('Work_done', null, ['rows' => 4,'class'=>'form-control Work_done']) !!}
					</div>
 --}}
