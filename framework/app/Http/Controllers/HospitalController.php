...
class HospitalController extends Controller
{
	...
	public function store(HospitalRequest $request)
	{
		...
		$hospital->directorate = $request->directorate;
		$hospital->type_of_healthfcilitys = $request->type_of_healthfacilityS;
	...
	public function update(HospitalRequest $request, $id)
	{
		...
		$hospital->governorate = $request->governorate;
		$hospital->directorate = $request->directorate;
		$hospital->type_of_healthfcility = $request->type_of_healthfcility;
		$hospital->email = $request->email;
		$hospital->contact_person = $request->contact_person;
		$hospital->phone_no = $request->phone_no;
		$hospital->mobile_no = $request->mobile_no;
