...
@section('breadcrumb')
	...
	<li class="active">@lang('equicare.edit_Directorates')</li>
@endsection
@section('styles')
	<style type="text/css">
		.mt-2{
		...
		<div class="col-md-12">
			<div class="box box-primary">
					<div class="box-header with-border">
						<h4 class="box-title">
							@lang('equicare.edit_Directorates')
						</h4>
					</div>
					<div class="box-body">
					@include ('errors.list')
						{!! Form::model($department,['url'=>['admin/Directorates',$department->id],'method'=>'PATCH']) !!}
						<div class="row">
							{!! Form::hidden('id',null) !!}
